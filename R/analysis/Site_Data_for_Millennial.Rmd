...
---
```
This R notebook prepares the site data from it's original forms so that it can be used to run the Millennial model. Data are described in Abramoff et al. (2021), and their references summarized in Table 2.
```
...
pdf(file=paste0(figdir, "FigureS_MAP.pdf"), height=4, width=7)
...
pdf(file=paste0(figdir, "FigureS_MAP_legend.pdf"), height=3, width=3)
