...
#Save plot
pdf(file=paste0(figdir,"param_sens_plot.pdf"), height=5, width=10)
print(par.sens.plot())
dev.off()
...
#Save plot
pdf(file=paste0(figdir,"param_coll_plot.pdf"), height=5, width=10)
print(par.coll.plot())
dev.off()
...
pdf(file=paste0(figdir,"eq_plots_temp_all.pdf"), height=4.24, width=9)
...
pdf(file=paste0(figdir,"eq_plots_vwc_all.pdf"), height=4.24, width=9)
print(ggplot(EqRuns5pool) +
...
pdf(file=paste0(figdir,"eq_plots_npp_all.pdf"), height=4.24, width=9)
print(ggplot(EqRuns5pool) +
...
pdf(file=paste0(figdir,"eq_plots_pH_all.pdf"), height=4.24, width=9)
print(ggplot(EqRuns5pool) +
...
pdf(file=paste0(figdir,"eq_plots_clay_all.pdf"), height=4.24, width=9)
print(ggplot(EqRuns5pool) +
...
pdf(file=paste0(figdir,"eq_plots_compressed_all.pdf"), height=4, width=10)
multiplot(g1, g5, g2, g4, g3, cols=3)
dev.off()

pdf(file=paste0(figdir,"eq_plots_legend_all.pdf"), height=4, width=4)
print(g.legend)
dev.off()
}
```
...
#Plot model performance - training dataset
ymax_plot <- 30
ylab.ml <- expression("Predicted C stock (kg C " ~ m^{2} ~ ")")
xlab.ml <- expression("Observed C stock (kg C " ~ m^{2} ~ ")")
pdf(file=paste0(figdir,paste0("FigureS_MLIN.pdf")), height=5, width=5)
par(mfrow = c(2,2))
...
#Plot model performance - testing dataset
pdf(file=paste0(figdir,paste0("FigureS_MLOUT.pdf")), height=5, width=5)
par(mfrow = c(2,2))
par(mar = c(3.5,3.7,0,0.1)+.9)
par(oma = c(0,0,0,0))
...
#Plot sensitivity of model pools to temperature at equilibrium
pdf(file=paste0(figdir,"eq_plots_temp_all_Cent.pdf"), height=centheight, width=centwidth)
print(ggplot(EqRuns) +
    geom_smooth( aes(x=forc_st, y=value ), color="black") +
    theme_classic() + 
      theme(panel.grid = element_blank(), axis.text = element_text(size=10), axis.title = element_text(size=15), strip.text = element_text(size=15)) +
...
#Plot sensitivity of model pools to VWC at equilibrium
pdf(file=paste0(figdir,"eq_plots_vwc_all_Cent.pdf"), height=centheight, width=centwidth)
print(ggplot(EqRuns) +
    geom_smooth( aes(x=forc_sw, y=value ), color="black") +
      theme_classic() + 
            theme(panel.grid = element_blank(), axis.text = element_text(size=10), axis.title = element_text(size=15), strip.text = element_text(size=15)) +
...
#Plot sensitivity of model pools to litter inputs at equilibrium
pdf(file=paste0(figdir,"eq_plots_npp_all_Cent.pdf"), height=centheight, width=centwidth)
print(ggplot(EqRuns) +
    geom_smooth( aes(x=forc_npp, y=value ), color="black") +
      theme_classic() + 
            theme(panel.grid = element_blank(), axis.text = element_text(size=10), axis.title = element_text(size=15), strip.text = element_text(size=15)) +
...
pdf(file=paste0(figdir,"eq_plots_clay_all_Cent.pdf"), height=centheight, width=centwidth)
print(ggplot(EqRuns) +
    geom_smooth( aes(x=parm_clay, y=value ), color="black") +
      theme_classic() + 
            theme(panel.grid = element_blank(), axis.text = element_text(size=10), axis.title = element_text(size=15), strip.text = element_text(size=15)) +
